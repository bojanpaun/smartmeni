-- Slike za biblioteku recepata
--
-- ZAŠTO: vizuelni katalog je korisniji. Dodaje se image_url u recipe_library;
-- import kopira sliku u menu_items.image_url (meni prikazuje sliku, a emoji je
-- fallback kad slike nema). Slike se hostuju u javnom Storage bucketu
-- 'recipe-library' (puni ih scripts/seed_recipe_images.mjs preko service_role).

ALTER TABLE public.recipe_library ADD COLUMN IF NOT EXISTS image_url TEXT;

-- Javni Storage bucket za slike biblioteke (public URL; upis ide preko service_role).
INSERT INTO storage.buckets (id, name, public)
VALUES ('recipe-library', 'recipe-library', true)
ON CONFLICT (id) DO NOTHING;

-- RPC: dodato kopiranje image_url u novokreirani menu_item.
