-- Import RPC: mapiranje svih kategorija biblioteke na ciljnu kategoriju + is_bar.
-- Hrana (food/salad/breakfast/dessert) NIJE bar (ide u kuhinju); pića jesu bar.
-- Uvodi v_is_bar (ranije hardkodirano true). Ostalo isto kao 20260606000011.
...
BEGIN
  ...
  -- Ciljna kategorija: zadata ili auto (mapa kategorija → naziv + is_bar)
