-- Import iz biblioteke: prenosi i alergene, kalorije i vrijeme pripreme.
-- Pri kreiranju stavke postavlja sva tri polja; pri re-importu popunjava ona
-- koja su na postojećoj stavci prazna (admin vrijednosti se NE gaze) — isti
-- princip kao za sliku (20260606000008).
...
BEGIN
  ...
  -- 3) inventory_pro (mirror planUtils.hasAddon)
  ...
  IF v_existing.id IS NOT NULL THEN
    ...
    -- Popuni prazna polja iz biblioteke; ne gazi admin vrijednosti.
