...
export default function SpaView({ staffId, restaurantId }) {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    // Find spa_therapist record for this staff member
  ...
  return (
    <div>
      {appointments.length === 0 ? (
        <div className={s.empty}><div className={s.emptyIcon}>💆</div><div className={s.emptyText}>Nemate termina za danas.</div></div>
